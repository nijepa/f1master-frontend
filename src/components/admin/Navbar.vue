    ...
    <nav>
      ...
      <ul v-show="!mobile" class="navigation">
        ...
        <div class="navigation-sub">
          <router-link class="link" to="/admin/teams">Teams</router-link>
          <router-link class="link" to="/admin/drivers">Drivers</router-link>
          <router-link class="link" to="/admin/events">Events</router-link>
        </div>
        <router-link
...
export default {
  ...
  setup() {
    ...
    let scrollPosition = ref(window.screenY);
